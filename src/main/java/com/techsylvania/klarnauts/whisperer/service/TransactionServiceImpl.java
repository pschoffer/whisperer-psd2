...
public class TransactionServiceImpl implements TransactionService {
  ...
  private static final BigDecimal GOLD_AMOUNT = new BigDecimal("50000");
  private static final BigDecimal SILVER_AMOUNT = new BigDecimal("25000");
